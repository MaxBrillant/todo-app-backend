...
public interface UserProjectService {
    ...
    */
    ...
    void addNewProjectToUser(Long userId, Project project) throws AppEntityNotFoundException;

    void addExistingProjectToUser(Long userId, Long projectId) throws AppEntityNotFoundException;
